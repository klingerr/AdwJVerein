...
import de.jost_net.JVerein.gui.view.MailPersonalbogenView;
...
public class PersonalbogenMailAction implements Action
{
  ...
  public void handleAction(Object context) throws ApplicationException
  {
    try
    {
          ...
          && (context instanceof Mitglied || context instanceof Mitglied[]))
      {
        ...
        GUI.startView(MailPersonalbogenView.class.getName(), mail);
      }
      else
      {
